		...
		function edit(id)
		{
			...
			$.ajax({
				...
				success: function(data)
				{
					...
					$('[name="area_name"]').val(data.area_name);                   
					$('[name="area_code"]').val(data.area_code);                   
					$('[name="area_opening_date"]').val(data.area_opening_date);                   
					$('[name="area_closing_date"]').val(data.area_closing_date);                   
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="POST" id="new_form">
					...
					<input type="hidden" class="form-control" value="" name="area_id" id="id">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="date" name="area_opening_date" id="area_opening_date" class="form-control">
							<span class="help-block"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="date" name="area_closing_date" id="area_closing_date" class="form-control">
							<span class="help-block"></span>
						</div>
					</div>
					<div class="form-group">
