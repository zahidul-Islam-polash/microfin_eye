	...
	<script>
		...
		function add()
		{
			...
			$('.modal-title').text('Add: User Roles'); // Set Title to Bootstrap modal title
		}
		...
		function edit(id)
		{
			...
			$.ajax({
				...
				success: function(data)
				{
					...
					$('.modal-title').text('Edit: User Roles'); // Set title to Bootstrap modal title
				}
			});
		}
	</script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="POST" id="new_form">
					...
					<input type="hidden" class="form-control" value="" name="role_id" id="id">

					<div class="form-group">
						<label class="control-label col-md-4">User roles :</label>
						<div class="col-md-6">
							<input type="text" name="role_name" id="role_name" class="form-control" placeholder="User Role">
