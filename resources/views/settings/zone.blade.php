	...
	<script>
		...
		function add()
		{
			...
			$('.modal-title').text('Add: Zone'); // Set Title to Bootstrap modal title
		}
		...
		function edit(id)
		{
			...
			$.ajax({
				...
				success: function(data)
				{
					$('[name="zone_id"]').val(data.zone_id);             
					$('[name="zone_name"]').val(data.zone_name);                   
					$('[name="zone_code"]').val(data.zone_code);                   
					$('[name="zone_opening_date"]').val(data.zone_opening_date);                   
					$('[name="zone_closing_date"]').val(data.zone_closing_date);                   
					$('[name="status"]').val(data.status);                     
					$('#modal_form').modal('show'); // show bootstrap modal when complete loaded
					$('.modal-title').text('Edit: Zone'); // Set title to Bootstrap modal title
				}
			});
		}
	</script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="POST" id="new_form">
					...
					<input type="hidden" class="form-control" value="" name="zone_id" id="id">

					<div class="form-group">
						<label class="control-label col-md-4">Zone Name :</label>
						<div class="col-md-6">
							<input type="text" name="zone_name" id="zone_name" class="form-control" placeholder="Zone Name">
							<span class="help-block"></span>
						</div>
					</div>
					
					<div class="form-group">
						<label class="control-label col-md-4">Zone Code :</label>
						<div class="col-md-6">
							<input type="text" name="zone_code" id="zone_code" class="form-control" placeholder="Zone Code">
							<span class="help-block"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="date" name="zone_opening_date" id="zone_opening_date" class="form-control">
							<span class="help-block"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="date" name="zone_closing_date" id="zone_closing_date" class="form-control">
							<span class="help-block"></span>
						</div>
					</div>
					<div class="form-group">
