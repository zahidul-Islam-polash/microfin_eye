		...
		function edit(id)
		{
			...
			$.ajax({
				...
				success: function(data)
				{
					...
					$('[name="sale_date"]').val(data.sale_date);                                   
					$('[name="passbook_no"]').val(data.passbook_no);                                   
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form class="form-horizontal" role="form" method="POST" id="new_form">
					...
					<input type="hidden" class="form-control" value="" name="sale_id" id="id">
					...
					<div class="form-group">
						<label class="control-label col-md-4">Passbook No :</label>
						<div class="col-md-6">
